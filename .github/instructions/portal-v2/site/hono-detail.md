...
- **Outgoing Response**: Logs the HTTP method, request path, response status code, and request/response timing.
...
When this hook is used, the Component is evaluated at the following two phases.
